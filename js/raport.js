  ...
  jQuery(document).ready(function($) {
    ...
    //http://vnete.org/ajax-poisk-tovara-pri-vvode-bukvy/  вот как реализовать надо поиск по букве
    ...
    //#TODO можно сделать метод который будет добавлять новую рубрику если такой нету, после брать id  последней добавленной рубрики и вставить в плагин (надо узнать куда относится) 
    //#города или инстанции и занести в плагин в базу
