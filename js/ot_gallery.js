	...
	var OT_gallery = {
		...
		main_image :  function (element) {
			if(element) {
				...
				return jQuery('.ot-slide-item').find(".ot-gallery-image"); 
			} else {
		...
		next_button :  function (element) {
		 	...
		 	return jQuery('.ot-slide-item').find(".next"); 
		 },

		//previous button location
		prev_button :  function (element) {
		 	//return element.closest('.ot-slide-item').find(".prev"); 
		 	return jQuery('.ot-slide-item').find(".prev"); 
		 },

		//next image number
		next_image :  function (element) {
		 	//return element.closest('.ot-slide-item').find(".next-image"); 
		 	return jQuery('.ot-slide-item').find(".next-image"); 
		 },
		...
		total_img :  function (element) {
		 	...
		 	return jQuery('.photo-gallery-full .photo-num-count').data("total");
		 },
