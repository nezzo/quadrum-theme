<?php
	...
	function theme_menu() {
		...
		add_theme_page(THEME_FULL_NAME.esc_html__(" Management",'quadrum-theme'), THEME_FULL_NAME.esc_html__(" Management",'quadrum-theme'), 'administrator', 'theme-configuration', 'theme_configuration');
