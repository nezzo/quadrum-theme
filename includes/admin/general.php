...
array(
	"type" => "title",
	"title" => __("Header Share Buttons",'quadrum-theme'),
),

array(
	"type" => "checkbox",
	"title" => "Show:",
	"id"=>$orange_themes_managment->themeslug."_share_icons"
),
...
array(
	"type" => "title",
	"title" => __("Social Buttons On Right Side",'quadrum-theme'),
),

array(
	"type" => "checkbox",
	"title" => __("Show:",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_social"
),
array(
	"type" => "input",
	"title" => __("Facebook Account URL",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_social_facebook",
	"protected" => array(
		array("id" => $orange_themes_managment->themeslug."_social", "value" => "on")
	)
),

array(
	"type" => "input",
	"title" => __("Twitter Account URL",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_social_twitter",
	"protected" => array(
		array("id" => $orange_themes_managment->themeslug."_social", "value" => "on")
	)
),
array(
	"type" => "input",
	"title" => __("Google+ Account URL",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_social_google",
	"protected" => array(
		array("id" => $orange_themes_managment->themeslug."_social", "value" => "on")
	)
),
...
array(
	"type" => "title",
	"title" => __("Category Jumplist",'quadrum-theme'),
),

array(
	"type" => "checkbox",
	"title" => __("Show:",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_jumplist"
),

array(
	"type" => "multiple_select",
	"id" => $orange_themes_managment->themeslug."_jumplist_cat",
	"taxonomy" => "category",
	"title" => __("Set Jumplist Category",'quadrum-theme'),
	"protected" => array(
		array("id" => $orange_themes_managment->themeslug."_jumplist", "value" => "on")
	)
),
...
array(
	"type" => "title",
	"title" => __("Allow visitors to rate posts (only in case, if the post has a editros review too)",'quadrum-theme'),
),

array(
	"type" => "checkbox",
	"title" => "Allow:",
	"id"=>$orange_themes_managment->themeslug."_visitor_rate"
),
...
array(
	"type" => "title",
	"title" =>	__("Post Settings",'quadrum-theme')
),

array(
	"type" => "checkbox",
	"title" => __("Show post date in post lists:",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_post_date"
),

array(
	"type" => "checkbox",
	"title" => __("Show post comment count in post lists:",'quadrum-theme'),
	"id"=>$orange_themes_managment->themeslug."_post_comment"
),

array(
	"type" => "checkbox",
	"title" => __("Show post author in blog page:",'quadrum-theme'),
	"id"=> $orange_themes_managment->themeslug."_post_author"
),

array(
	"type" => "checkbox",
	"title" => __("Show post date in single post:",'quadrum-theme'),
	"id"=>	$orange_themes_managment->themeslug."_post_date_single"
),

array(
	"type" => "checkbox",
	"title" => __("Show post author in single post:",'quadrum-theme'),
...
array(
	"type" => "title",
	"title" => "Post Image Size In Post Listing Pages"
),
...
array(
	"type" => "title",
	"title" => __("Top Banner",'quadrum-theme')

),

array(
	"type" => "checkbox",
	"title" => __("Enable Banner",'quadrum-theme'),
...
array(
	"type" => "textarea",
	"title" => __("Banner HTML Code",'quadrum-theme'),
	"sample" => '<a href="http://www.orange-themes.com" target="_blank"><img src="'.THEME_IMAGE_URL.'banner-728x90.jpg" alt="" title="" /></a>',
...
array(
	"type" => "title",
	"title" => __("Default Single Post Banner",'quadrum-theme')
