...
class OT_popular_posts extends WP_Widget {
	function __construct() {
		 parent::__construct(false, $name = THEME_FULL_NAME.' '.__("Popular Posts",'quadrum-theme')
);	
	}
	...
	function form($instance) {
		...
		$defaults = array(
			'title' => __("Popular Posts",'quadrum-theme')
,
			'count' => '3',
			'cat' => '',
		);
...
;?></span>
								...
								<?php 
									...
									the_excerpt();
									remove_filter('excerpt_length', 'new_excerpt_length_7');
								?>
								<div class="item-foot">
